...
RUN apt-get install -y git composer php php-cli php-fpm php-json php-pdo php-mysql php-zip php-gd  php-mbstring php-curl php-xml php-pear php-bcmath

COPY . .

#RUN php -v
	
CMD php tools/build/CreateRelease.php --version="1.7.6.7x"
...
#COPY --from=builder tools/build/releases/prestashop_1.7.6.7x .
